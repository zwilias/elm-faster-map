module Fast.List8 exposing (foldr, map)
...
chunkAndMap op list chunks =
    case list of
        a :: b :: c :: d :: e :: f :: g :: h :: [] ->
            mapChunks op chunks [ op a, op b, op c, op d, op e, op f, op g, op h ]

        a :: b :: c :: d :: e :: f :: g :: [] ->
            mapChunks op chunks [ op a, op b, op c, op d, op e, op f, op g ]
...
mapChunks op chunks acc =
    case chunks of
        (a :: b :: c :: d :: e :: f :: g :: h :: _) :: xs ->
            mapChunks op xs (op a :: op b :: op c :: op d :: op e :: op f :: op g :: op h :: acc)
...
chunkAndFoldr op acc list chunks =
    case list of
        a :: b :: c :: d :: e :: f :: g :: h :: [] ->
            foldChunks op chunks (op a (op b (op c (op d (op e (op f (op g (op h acc))))))))

        a :: b :: c :: d :: e :: f :: g :: [] ->
            foldChunks op chunks (op a (op b (op c (op d (op e (op f (op g acc)))))))
...
foldChunks op chunks acc =
    case chunks of
        (a :: b :: c :: d :: e :: f :: g :: h :: _) :: xs ->
            foldChunks op xs (op a (op b (op c (op d (op e (op f (op g (op h acc))))))))
